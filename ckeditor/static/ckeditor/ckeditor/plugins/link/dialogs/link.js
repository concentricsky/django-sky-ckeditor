...
CKEDITOR.dialog.add( 'link', function( editor )
{
	...
	{
		var dialog = this.getDialog(),
			partIds = [ 'contentOptions', 'urlOptions', 'anchorOptions', 'emailOptions' ],
					...
					},
					{
						...
						[

							{
								...
								setup : function( data )
								{
									if ( data.contentobject )
										this.setValue( data.contentobject.type || '' );
								},
								commit : function( data )
								{
									if ( !data.contentobject )
							...
							},
							{
								...
								{
									if ( data.contentobject )
										this.setValue( data.contentobject.id );

									var linkType = this.getDialog().getContentElement( 'info', 'linkType' );
									if ( linkType && linkType.getValue() == 'content' )
										this.select();
								},
								commit : function( data )
								{
